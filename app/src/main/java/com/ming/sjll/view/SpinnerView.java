...
//                defaultPadding);
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (onSpinnerItemSelectedListener != null) {
                    onSpinnerItemSelectedListener.onItemSelected(SpinnerView.this, view, position, id);
                }
    ...
    public <T> void attachDataSource(@NonNull List<T> list) {
        adapter = new NiceSpinnerAdapter<T>(getContext(), list, textColor, backgroundSelector, spinnerTextFormatter, horizontalAlignment);
