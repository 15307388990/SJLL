 ...
 * 采购商视觉
 */
public class PurchaserVisualFragemt extends MvpFragment<PurchaserVisualView, PurchaserVisualPresenter> implements PurchaserVisualView {
    ...
    @Override
    protected PurchaserVisualPresenter createPresenter() {
        return new PurchaserVisualPresenter();
    }
