 ...
 * 项目管理
 */
public class ProjectManagementAcitivity extends MvpActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        binding.setTitleViewModel(new ToolbarViewModel("项目管理"));
        initEvent();
    }
    ...
    public void initEvent() {
        ...
        fragmentList.add(ProjectManagementFragemt.newInstance("0"));
        fragmentList.add(ProjectManagementFragemt.newInstance("1"));
        binding.viewpager.setAdapter(new Adaper(getSupportFragmentManager()));
        List<String> mTitleDataList = new ArrayList<>();
        mTitleDataList.add("未接单");
        mTitleDataList.add("已接单");
        ...
        commonNavigator.setAdapter(new CommonNavigatorAdapter() {
            ...
            public IPagerIndicator getIndicator(Context context) {
                LinePagerIndicator indicator = new LinePagerIndicator(ProjectManagementAcitivity.this);
                indicator.setMode(2);
                indicator.setRoundRadius(5);
                indicator.setColors(getResources().getColor(R.color.LL_0A3FFF));//线的颜色
                indicator.setLineWidth(Tools.dip2px(ProjectManagementAcitivity.this, 12));
                return indicator;
            }
        });
