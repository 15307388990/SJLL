...
//
//
//        int alpha = a.getInteger(R.styleable.TitleBar_tbar_Background_alpha,-1);
//
...
//
//
//        boolean showLineBottom = a.getBoolean(R.styleable.TitleBar_tbar_showLineBottom, false);
//
...
//
//    /**
//     * 设置背景色透明度，如果toolbar和barView都有背景，则一起改变
//     * @param alpha
//     */
//    public void setBackgroundAlpha(@IntRange(from=0,to=255) int alpha){
//        Drawable bgToolBar = this.getBackground();
//        if(bgToolBar != null){
//            bgToolBar.mutate().setAlpha(alpha);
//        }
//        Drawable bgBarView = this.mBarView.getBackground();
//        if(bgBarView != null){
//            bgBarView.mutate().setAlpha(alpha);
//        }
//    }
//
//
...
//        }
//
//        public Builder setBackgroundAlpha(@IntRange(from=0,to=255) int alpha){
//            this.P.mBackgroundAlpha = alpha;
//            return this;
//        }
//
//        /**
...
//         * @return
//         */
//        public Builder showLeftImg(@DrawableRes int imgRes, View.OnClickListener onClickListener) {
...
//         * @return
//         */
//        public Builder showRightImg(@DrawableRes int imgRes, View.OnClickListener onClickListener) {
...
//         * @return
//         */
//        public Builder showRightImg_2(@DrawableRes int imgRes, View.OnClickListener onClickListener) {
...
//         * @return
//         */
//        public Builder showRightTxt(String txt, View.OnClickListener onClickListener) {
...
//
//
//        public Builder showRightTxt(CharSequence txt, View.OnClickListener onClickListener) {
//            this.P.mRightTxtVisible = true;
//            this.P.mRightTxt = txt;
//            if (null != onClickListener) {
//                this.P.mRightTxtClickListener = onClickListener;
...
//         * @return
//         */
//        public Builder showRightTxt(@StringRes int txtRes, View.OnClickListener onClickListener) {
//            this.P.mRightTxtVisible = true;
...
//        int mRightImgRes_2;
//        View.OnClickListener mRightClickListener_2;
//
//        boolean mRightTxtVisible;
//        int mRightTxtRes;
//        CharSequence mRightTxt;
//        View.OnClickListener mRightTxtClickListener;
//
//        TitleBarParams(Context context) {
//            this.mContext = context;
//        }
//
//        View.OnClickListener mDefClickListener = new View.OnClickListener() {
//            @Override
//            public void onClick(View v) {
...
//            }
//
//            if(mBackgroundAlpha > -1){
//                titleBar.setBackgroundAlpha(mBackgroundAlpha);
//            }
//
//            if (mTitleRes != 0) {
